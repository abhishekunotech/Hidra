...
func callListTicketState(w http.ResponseWriter, r *http.Request, username string, password string){
...
func GetListTicketState(w http.ResponseWriter, r *http.Request) {
	...
	mapHttp := r.URL.Query()
        ...
        callListTicketState(w,r,userName, password)
